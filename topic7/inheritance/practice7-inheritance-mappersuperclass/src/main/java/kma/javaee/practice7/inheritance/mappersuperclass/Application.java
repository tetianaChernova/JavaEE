...
import kma.javaee.practice7.inheritance.mappersuperclass.entities.GiraffeEntity;
import kma.javaee.practice7.inheritance.mappersuperclass.entities.WolfEntity;
...
public class Application {
	...
	public static void main(String[] args) {
		...
		List<Animal> myZooAnimals = List.of(
			...
			animalService.getAnimalById(1, WolfEntity.class)
		);
